...
/**
 * 刮削库仓库 SQLDelight 实现(desktopMain/JDBC)。
 *
 ...
 */
class ScrapedLibraryRepositoryImpl internal constructor(
    private val queries: ScrapedQueries,
    ...
    companion object {
        ...
        fun get(): ScrapedLibraryRepositoryImpl =
            instance ?: synchronized(this) {
                instance ?: ScrapedLibraryRepositoryImpl(UnuDatabaseProvider.get().scrapedQueries).also { instance = it }
            }
    }
}
