 ...
 *
 * 选项列表与文案平台不同:
 * - Android: MediaCodec 硬解 + audiotrack/opensles/aaudio
 * - 桌面: vaapi/nvdec/d3d11va + pipewire/pulse/alsa/wasapi(audiotrack/opensles/aaudio 是 Android 专属)
...
@Composable
expect fun AnimePortraitPlaybackSection(
    state: SettingsState,
