...
@Serializable
internal data class EmbyPublicInfoDto(
...
@Serializable
internal data class EmbyAuthenticateRequestDto(
    @SerialName("Username") val username: String,
    @SerialName("Pw") val password: String,
)

@Serializable
internal data class EmbyAuthenticationResultDto(
...
@Serializable
internal data class EmbyItemsResultDto(
...
internal data class EmbyItemDto(
    ...
    // 注: Emby 的 ProviderIds 键名是否恒为 "Tmdb" 未经真实服务器验证(只验了 Jellyfin), 暂按 "Tmdb" 取。
...
@Serializable
internal data class EmbyPlaybackRequestDto(
...
@Serializable
internal data class EmbyPlaybackInfoDto(
...
@Serializable
internal data class EmbyMediaStreamDto(
...
@Serializable
internal data class EmbyPlaybackStoppedDto(
    @SerialName("ItemId") val itemId: String,
    @SerialName("MediaSourceId") val mediaSourceId: String,
    @SerialName("PlaySessionId") val playSessionId: String? = null,
    @SerialName("PositionTicks") val positionTicks: Long,
